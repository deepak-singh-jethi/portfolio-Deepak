    ...
    <motion.div
      ...
      <div className="flex justify-center md:justify-start items-center flex-wrap gap-8">
        <motion.div
          ...
          <a
            href="https://www.linkedin.com/in/deepak-singh-jethi-bb7061228/"
            target="blank">
            <img
              src={linkedin}
              alt="github"
              className="w-14 md:w-20 bg-white rounded-full hover:border-2 hover:border-yellow-300"
            />
          </a>
        </motion.div>
        <motion.div
          ...
          <a href="https://github.com/deepak-singh-jethi" target="blank">
            <img
              src={github}
              alt="github"
              className="w-14 md:w-20 bg-white rounded-full hover:border-2 hover:border-yellow-300"
